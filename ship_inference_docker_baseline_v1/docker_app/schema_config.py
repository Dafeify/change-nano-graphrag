...
# - 不包含未知舰级名称；
# - 不建立“未知驱逐舰/未知护卫舰签名表”；
# - open-set 由“已知类证据不足/已知类冲突”触发，而不是由未知类专属特征触发。

V28_RULE_THRESHOLDS: Dict[str, float] = {
    "anchor_known": 12.0,
    "support_known": 10.0,
    "category_cue_known": 5.0,
    "support_with_category_known": 5.0,
    "adjusted_known": 11.0,
    "soft_conflict_block": 12.0,
    "hard_conflict_block": 18.0,
    "anchor_override_conflict": 18.0,
    "anchor_min_not_weak": 6.0,
    "support_min_not_weak": 7.0,
    "adjusted_min_not_weak": 7.0,
    "cross_target_category_min": 5.0,
    "cross_anchor_force": 24.0,
    "cross_support_force": 20.0,
    "raw_category_override_min": 8.0,
}

V28_CATEGORY_CUES: Dict[str, List[Tuple[str, float]]] = {
    "航空母舰": [("航空母舰", 8), ("航母", 7), ("超级航母", 9), ("主力航母", 9), ("核动力航母", 10), ("海上机场", 6)],
    "巡洋舰": [("巡洋舰", 9), ("导弹巡洋舰", 12), ("宙斯盾巡洋舰", 12), ("指挥舰", 6), ("舰队指挥", 6), ("航母战斗群的指挥中心", 8)],
    "驱逐舰": [("驱逐舰", 9), ("导弹驱逐舰", 10), ("宙斯盾驱逐舰", 10), ("防空驱逐舰", 9), ("主力驱逐舰", 8), ("带刀护卫", 6)],
    "护卫舰": [("护卫舰", 9), ("巡防舰", 9), ("反潜护卫舰", 10), ("通用护卫舰", 9), ("现代护卫舰", 8), ("中型护卫舰", 8), ("单体护卫舰", 8)],
    "两栖舰": [("两栖舰", 8), ("两栖攻击舰", 12), ("两栖船坞运输舰", 12), ("两栖运输舰", 10), ("LPD", 10), ("LHD", 10), ("运兵和车辆", 6), ("运兵和装备", 6)],
    "登陆舰": [("登陆舰", 10), ("船坞登陆舰", 12), ("船坞登陆", 10), ("LSD", 10), ("登陆装备", 6)],
}

V28_KNOWN_CLASS_RULES: Dict[str, Dict[str, List[Tuple[str, float]]]] = {
    "尼米兹级航空母舰": {
        "anchor": [
            ("尼米兹级", 30), ("尼米兹", 28), ("核动力航空母舰", 20), ("超级航母", 16),
            ("10万吨", 18), ("十万吨", 18), ("超过10万吨", 20), ("104200吨", 18),
            ("4台蒸汽弹射器", 26), ("四台蒸汽弹射器", 26), ("4台弹射器", 22), ("四台弹射器", 22),
            ("4条拦阻索", 24), ("四条拦阻索", 24), ("A4W", 18), ("A4W压水反应堆", 22),
            ("C-13", 14), ("舰长332.8", 16), ("332.8米", 16),
        ],
        "support": [
            ("航母", 5), ("航空母舰", 6), ("海上机场", 6), ("核动力", 7),
            ("全通飞行甲板", 6), ("斜角飞行甲板", 8), ("斜角", 5),
            ("弹射器", 8), ("弹射", 6), ("把飞机弹出去", 8),
            ("拦阻索", 8), ("降落拦阻", 8), ("固定翼飞机", 8), ("固定翼舰载机", 10),
            ("大量固定翼", 8), ("很多飞机", 6), ("好多飞机", 6), ("舰载机", 5),
            ("右舷舰岛", 5), ("右边有一个高高的岛", 5), ("整条甲板", 5),
        ],
        "conflict": [
            ("两栖攻击舰", 16), ("两栖船坞运输舰", 18), ("船坞登陆舰", 18), ("登陆舰", 12),
            ("坞舱", 12), ("艉门", 12), ("尾门", 12), ("LCAC", 12),
            ("垂直起降战斗机", 12), ("AV-8B", 12), ("F-35B", 12), ("三体船", 18), ("濒海战斗舰", 18),
        ],
    },
    "提康德罗加级导弹巡洋舰": {
        "anchor": [
            ("提康德罗加级", 30), ("提康德罗加", 28), ("导弹巡洋舰", 24), ("宙斯盾巡洋舰", 24),
            ("122单元", 34), ("共122单元", 36), ("122单元MK41", 38), ("122单元Mk41", 38),
            ("16组八联装", 34), ("16组八联装MK41", 38), ("16组八联装Mk41", 38),
            ("舰首和舰尾各有", 26), ("舰艏和舰艉各有", 26), ("双主炮", 24),
            ("第一种正式使用宙斯盾系统", 24), ("唯一一级巡洋舰", 22),
            ("比伯克级大", 18), ("比阿利·伯克级大", 18), ("能当指挥舰", 18),
        ],
        "support": [
            ("巡洋舰", 8), ("好像是巡洋舰", 8), ("宙斯盾舰", 5), ("AN/SPY-1", 6), ("SPY-1", 5),
            ("很多垂直发射", 6), ("垂发数量很多", 6), ("很多导弹发射井", 6),
            ("前后都有垂发", 6), ("前后都有发射区域", 6), ("前后甲板可见武器发射区域", 6),
            ("船头和船尾好像都有炮", 8), ("前后都有炮", 8),
            ("标准防空导弹", 5), ("战斧巡航导弹", 5), ("航母护航", 6), ("指挥中心", 6),
            ("指挥控制", 5), ("舰体修长", 4), ("上层建筑较高", 4),
            ("舰尾设有直升机库", 5), ("舰尾有直升机甲板", 4),
            ("舰长172.8", 10), ("172.8m", 10), ("9480吨", 10), ("9500吨", 8), ("80000马力", 8),
        ],
        "conflict": [
            ("Flight IIA", 18), ("96单元", 18), ("两座直升机库", 16),
            ("三体船", 18), ("濒海战斗舰", 18), ("全通飞行甲板", 12), ("斜角飞行甲板", 12),
            ("两栖攻击舰", 16), ("两栖船坞运输舰", 18), ("船坞登陆舰", 18), ("10万吨", 18), ("核动力航空母舰", 18),
        ],
    },
    "阿利·伯克级驱逐舰": {
        "anchor": [
            ("阿利·伯克级", 30), ("阿利伯克级", 30), ("伯克级", 22),
            ("SPY-1D", 28), ("AN/SPY-1D", 28), ("Flight IIA", 28), ("FlightIIA", 28), ("IIA型", 18),
            ("96单元", 26), ("96单元MK41", 30), ("96单元Mk41", 30),
            ("两座直升机库", 24), ("增设了直升机库", 20), ("后面有直升机库", 16),
            ("9238吨", 18), ("155.29m", 16),
        ],
        "support": [
            ("美国海军主力驱逐舰", 14), ("主力驱逐舰", 10), ("美国最常见的那种宙斯盾驱逐舰", 16),
            ("隐身化上层建筑", 8), ("隐身化封闭式上层建筑", 10), ("外形有点隐身", 6),
            ("上层建筑外壁倾斜", 8), ("固定雷达阵面", 6), ("四面相控阵雷达", 6), ("四个大平板雷达", 6),
            ("舰艏主炮", 4), ("前后垂发阵列", 6), ("舰体前后区域存在垂发阵列", 8),
            ("大概90多个", 4), ("战斧导弹", 4), ("标准导弹", 4), ("防空、反潜和对海作战", 5),
        ],
        "conflict": [
            ("巡洋舰", 10), ("导弹巡洋舰", 18), ("122单元", 24), ("16组八联装", 24), ("双主炮", 20), ("舰首和舰尾各有", 20),
            ("三体船", 18), ("濒海战斗舰", 18), ("两栖攻击舰", 16), ("两栖船坞运输舰", 18), ("船坞登陆舰", 18),
            ("全通飞行甲板", 12), ("弹射器", 12), ("拦阻索", 12),
        ],
    },
    "独立级濒海战斗舰": {
        "anchor": [
            ("独立级", 30), ("濒海战斗舰", 28), ("三体船", 30), ("三体结构", 30), ("三体船型", 30),
            ("三个船体", 28), ("三个船身", 28), ("多体结构", 22), ("中央主船体两侧", 22),
            ("铝合金船体", 18), ("铝合金造", 16), ("任务模块", 18), ("模块化任务", 18), ("任务包", 16),
            ("最高航速超过45节", 22), ("45-50节", 20),
        ],
        "support": [
            ("低矮", 5), ("船体比较宽", 5), ("不是普通单体船", 10), ("可能不是普通单体船", 8),
            ("宽大的飞行甲板", 5), ("大型开放式直升机甲板", 6), ("可同时操作两架直升机", 6),
            ("速度很快", 5), ("跑得特别快", 6), ("外形很特别", 5), ("57毫米", 6), ("57mm", 6),
        ],
        "conflict": [
            ("普通单体船", 16), ("传统单体船", 16), ("单体护卫舰", 16), ("反潜护卫舰", 16),
            ("导弹巡洋舰", 18), ("122单元", 18), ("阿利·伯克级", 18), ("Flight IIA", 16),
            ("两栖攻击舰", 16), ("两栖船坞运输舰", 18), ("船坞登陆舰", 18), ("10万吨", 18),
        ],
    },
    "黄蜂级两栖攻击舰": {
        "anchor": [
            ("黄蜂级", 30), ("两栖攻击舰", 30), ("LHD", 18), ("小航母", 16),
            ("垂直起降战斗机", 24), ("AV-8B", 24), ("F-35B", 24), ("STOVL", 24),
            ("3艘LCAC", 24), ("三艘LCAC", 24), ("41150吨", 22), ("四万多吨", 14),
            ("舰长253.2", 16), ("253.2米", 16),
        ],
        "support": [
            ("全通飞行甲板", 6), ("全通式飞行甲板", 6), ("全通甲板", 6),
            ("外形近似航母", 7), ("像小航母", 10), ("能当小航母用", 10),
            ("直升机", 3), ("多个直升机起降点", 6), ("坞舱", 6), ("大型坞舱门", 10),
            ("后面还有坞舱", 8), ("气垫登陆艇", 6), ("气垫艇", 6),
            ("没有弹射器和拦阻索", 10), ("无弹射器和拦阻索", 10), ("缺少弹射器和拦阻索", 10),
            ("海军陆战队", 5), ("两栖投送", 5),
        ],
        "conflict": [
            ("弹射器", 12), ("拦阻索", 12), ("核动力航空母舰", 18), ("10万吨", 18),
            ("两栖船坞运输舰", 18), ("LPD", 18), ("圣安东尼奥", 22), ("2艘LCAC", 18),
            ("船坞登陆舰", 18), ("LSD", 18), ("4艘LCAC", 20), ("井围甲板", 18),
            ("导弹巡洋舰", 16), ("导弹驱逐舰", 14),
        ],
    },
    "圣安东尼奥级两栖船坞运输舰": {
        "anchor": [
            ("圣安东尼奥级", 30), ("圣安东尼奥", 28), ("两栖船坞运输舰", 32), ("船坞运输舰", 26),
            ("LPD", 18), ("封闭式桅杆", 22), ("一体化桅杆", 22), ("先进的封闭式桅杆", 24),
            ("MV-22", 24), ("鱼鹰", 24), ("倾转旋翼机", 24),
            ("2艘LCAC", 24), ("两艘LCAC", 24), ("25300吨", 20), ("舰长208", 16),
            ("车辆甲板面积2230", 18), ("货舱容积962", 18), ("720名海军陆战队员", 18),
        ],
        "support": [
            ("两栖运输舰", 10), ("美国的两栖运输舰", 12), ("运输舰", 5),
            ("有坞舱能放登陆艇", 9), ("有坞舱和直升机库", 10), ("也有直升机库", 7), ("直升机库", 4),
            ("能运兵和车辆", 9), ("运兵和装备", 9), ("车辆甲板", 6), ("货舱", 5),
            ("大型运输舰", 5), ("方盒子一样的舰桥建筑", 8), ("船尾似乎能打开让登陆艇进出", 8),
        ],
        "conflict": [
            ("两栖攻击舰", 18), ("LHD", 18), ("全通飞行甲板", 14), ("全通甲板", 14), ("AV-8B", 16), ("F-35B", 16), ("STOVL", 16), ("3艘LCAC", 18),
            ("船坞登陆舰", 18), ("LSD", 18), ("4艘LCAC", 20), ("大型井围甲板", 18), ("无机库", 14),
            ("导弹巡洋舰", 16), ("导弹驱逐舰", 14), ("核动力航空母舰", 18),
        ],
    },
    "惠德比岛级船坞登陆舰": {
        "anchor": [
            ("惠德比岛级", 30), ("惠德比", 28), ("船坞登陆舰", 32), ("船坞登陆", 26), ("LSD", 18),
            ("大型井围甲板", 28), ("井围甲板", 26), ("大型泛水坞舱", 24),
            ("4艘LCAC", 28), ("四艘LCAC", 28), ("可容纳4艘LCAC", 28),
            ("21艘LCM-6", 18), ("16100吨", 22), ("满载排水量16100吨", 24),
            ("舰长185.8", 16), ("185.8m", 16), ("627名海军陆战队员", 16),
            ("无机库", 16), ("没有直升机库", 16),
        ],
        "support": [
            ("登陆舰", 7), ("大坞舱", 10), ("大型坞舱", 9), ("大坞舱门", 6),
            ("放好几艘气垫登陆艇", 10), ("用来放登陆艇", 9), ("专门用来放登陆艇", 10),
            ("尾门", 7), ("很大的尾门", 9), ("舰尾有一个巨大的坞舱门", 9),
            ("大型车辆甲板", 6), ("后部是宽大的飞行甲板", 4), ("主要看起来是登陆运输用", 7),
            ("运输登陆装备", 10), ("一万六千吨", 8), ("16000吨", 8),
        ],
        "conflict": [
            ("两栖船坞运输舰", 18), ("LPD", 18), ("圣安东尼奥", 22), ("MV-22", 18), ("鱼鹰", 18), ("2艘LCAC", 18),
            ("两栖攻击舰", 18), ("LHD", 18), ("全通飞行甲板", 14), ("AV-8B", 16), ("F-35B", 16), ("3艘LCAC", 18),
            ("导弹巡洋舰", 16), ("导弹驱逐舰", 14), ("核动力航空母舰", 18),
        ],
    },
}
...
# ============================================================
# v29 slot-based known-only 后处理规则
# ============================================================
# 严格原则：
# - 只描述 7 个已知舰级自身的先验特征；
# - 不包含任何未知舰级名称；
# - 不包含“未知驱逐舰/未知护卫舰”的方向签名；
# - open-set 由“已知类证据不足/与已知类冲突”触发。

V29_RULE_THRESHOLDS: Dict[str, float] = {
    # slot 规则判定阈值
    "anchor_known": 8.0,
    "support_known": 14.0,
    "support_with_anchor": 8.0,
    "anchor_low": 4.0,
    "conflict_block": 12.0,
    "hard_conflict_block": 18.0,

    # 闭集弱匹配拒识阈值
    "closed_min_anchor": 4.0,
    "closed_min_total": 9.0,

    # 跨大类纠偏必须更严格
    "cross_anchor_known": 12.0,
    "cross_total_known": 18.0,
}

# 规则格式：
# (group.slot, [可匹配值/短语...], weight)
# group.slot 支持特殊值 "_RAW.raw_text"，但 v29 主要使用 observed_attributes 卡槽。
V29_KNOWN_CLASS_SLOT_RULES: Dict[str, Dict[str, List[Tuple[str, List[str], float]]]] = {
    "尼米兹级航空母舰": {
        "anchor": [
            ("AVIATION_FEATURES.Catapult", ["有"], 7.0),
            ("AVIATION_FEATURES.Catapult_Count", ["4", "4台", "四台"], 8.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["有"], 7.0),
            ("AVIATION_FEATURES.Arresting_Gear_Count", ["4", "4条", "四条"], 8.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["斜角飞行甲板", "全通飞行甲板"], 5.0),
            ("AVIATION_FEATURES.Fixed_Wing_Aircraft_Operation", ["有"], 5.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["10万吨", "100000", "超过10万吨", "十万吨"], 8.0),
            ("TEXT_ATTRIBUTES.Length_Overall", ["332.8", "333"], 6.0),
            ("TEXT_ATTRIBUTES.Aircraft_Capacity", ["85", "100", "超过100"], 5.0),
            ("TEXT_ATTRIBUTES.Powerplant", ["核动力", "A4W"], 7.0),
            ("EQUIPMENT_DETAILS.Powerplant_Detail", ["A4W", "核反应堆", "压水核反应堆"], 8.0),
            ("TEXT_STRONG_CUES.Keywords", ["海上机场", "超级航母", "核动力航空母舰", "弹射器", "拦阻索"], 4.0),
        ],
        "support": [
            ("VISUAL_STRUCTURE.Island_Position", ["右舷舰岛"], 3.0),
            ("VISUAL_STRUCTURE.Island_Presence", ["有"], 2.0),
            ("AVIATION_FEATURES.Flight_Deck_Position", ["全舰贯通", "全舰贯通并延伸至舰艉"], 4.0),
            ("AVIATION_FEATURES.Aircraft_Capacity_Level", ["大量固定翼舰载机"], 4.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["无"], 2.0),
            ("AMPHIBIOUS_FEATURES.Stern_Gate", ["无"], 2.0),
            ("NEGATIVE_FEATURES.No_Well_Deck", ["是"], 2.0),
            ("NEGATIVE_FEATURES.No_Stern_Gate", ["是"], 2.0),
        ],
        "conflict": [
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱", "全通式泛水坞舱"], 10.0),
            ("AMPHIBIOUS_FEATURES.Stern_Gate", ["有"], 8.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capability", ["有", "强", "LCAC", "登陆艇"], 8.0),
            ("AVIATION_FEATURES.Catapult", ["无"], 8.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 8.0),
            ("AVIATION_FEATURES.STOVL_Aircraft_Operation", ["有"], 6.0),
        ],
    },

    "提康德罗加级导弹巡洋舰": {
        "anchor": [
            ("TEXT_STRONG_CUES.Keywords", ["导弹巡洋舰", "宙斯盾巡洋舰", "122单元", "16组八联装", "双主炮", "舰队指挥", "指挥舰"], 6.0),
            ("WEAPON_SENSOR_FEATURES.VLS_Count_Level", ["122单元级", "122单元", "高", "大量"], 7.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Position", ["舰艏和舰艉", "舰首和舰尾", "前后"], 7.0),
            ("MISSION_FEATURES.Command_Control", ["有", "强", "舰队指挥", "指挥控制"], 5.0),
            ("MISSION_FEATURES.Primary_Mission", ["区域防空", "舰队指挥"], 5.0),
            ("TEXT_ATTRIBUTES.Length_Overall", ["172.8", "173"], 6.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["9480", "9500", "万吨级"], 5.0),
            ("TEXT_ATTRIBUTES.Power_Output", ["80000"], 5.0),
            ("EQUIPMENT_DETAILS.Combat_System", ["宙斯盾"], 4.0),
            ("EQUIPMENT_DETAILS.Radar_System", ["AN/SPY-1", "SPY-1"], 4.0),
            ("_RAW.raw_text", ["比伯克级大", "比阿利·伯克级大", "第一种正式使用宙斯盾系统", "16组八联装", "122单元", "172.8米", "9480吨", "80000马力", "6000海里", "航母战斗群区域防空", "火力规模更大", "指挥任务"], 7.0),
        ],
        "support": [
            ("WEAPON_SENSOR_FEATURES.VLS_Presence", ["有"], 2.5),
            ("WEAPON_SENSOR_FEATURES.Phased_Array_Radar", ["有"], 2.5),
            ("WEAPON_SENSOR_FEATURES.Radar_Array_Type", ["四面固定相控阵", "AN/SPY-1"], 3.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["艉部直升机甲板"], 2.0),
            ("AVIATION_FEATURES.Catapult", ["无"], 2.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 2.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["无"], 2.0),
            ("VISUAL_STRUCTURE.Superstructure_Type", ["传统多层上层建筑"], 3.0),
            ("MISSION_FEATURES.Area_Air_Defense", ["有", "强"], 3.0),
            ("MISSION_FEATURES.Anti_Submarine", ["有"], 1.5),
        ],
        "conflict": [
            ("AVIATION_FEATURES.Catapult", ["有"], 8.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["有"], 8.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板", "斜角飞行甲板"], 8.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 8.0),
            ("VISUAL_STRUCTURE.Hull_Form", ["三体船", "宽体三体船"], 10.0),
            ("TEXT_STRONG_CUES.Keywords", ["Flight IIA", "96单元", "两座直升机库", "濒海战斗舰", "三体船", "两栖攻击舰", "船坞登陆舰"], 8.0),
        ],
    },

    "阿利·伯克级驱逐舰": {
        "anchor": [
            ("TEXT_STRONG_CUES.Keywords", ["Flight IIA", "96单元", "阿利·伯克", "阿利伯克", "伯克级", "两座直升机库", "海鹰直升机", "SH-60", "SPY-1D"], 6.0),
            ("WEAPON_SENSOR_FEATURES.VLS_Count_Level", ["96单元级", "96单元"], 7.0),
            ("WEAPON_SENSOR_FEATURES.Radar_Array_Type", ["AN/SPY-1D"], 5.0),
            ("EQUIPMENT_DETAILS.Radar_System", ["AN/SPY-1D"], 5.0),
            ("AVIATION_FEATURES.Hangar", ["有直升机机库", "直升机机库", "有"], 4.0),
            ("EQUIPMENT_DETAILS.Aircraft", ["SH-60", "MH-60", "海鹰"], 6.0),
            ("TEXT_ATTRIBUTES.Length_Overall", ["155.29", "155"], 5.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["9200", "9238"], 5.0),
            ("_RAW.raw_text", ["Flight IIA", "96单元", "SPY-1D", "两座直升机库", "海鹰直升机", "SH-60", "阿利·伯克", "155米", "9200吨"], 7.0),
        ],
        "support": [
            ("TEXT_STRONG_CUES.Keywords", ["导弹驱逐舰", "宙斯盾驱逐舰", "主力驱逐舰", "隐身化封闭式", "前后垂发", "四面固定相控阵", "战斧导弹"], 3.0),
            ("WEAPON_SENSOR_FEATURES.VLS_Presence", ["有"], 2.0),
            ("WEAPON_SENSOR_FEATURES.VLS_Position", ["前后", "前后均有", "前后布置", "舰体前后区域"], 3.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Presence", ["有"], 1.5),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Position", ["舰艏", "前部", "舰首"], 2.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Caliber", ["127mm级"], 2.0),
            ("WEAPON_SENSOR_FEATURES.Phased_Array_Radar", ["有"], 2.5),
            ("VISUAL_STRUCTURE.Superstructure_Type", ["隐身化封闭式上层建筑", "隐身化封闭式结构", "隐身化上层建筑"], 3.0),
            ("VISUAL_STRUCTURE.Stealth_Shape", ["强隐身化外形"], 2.5),
            ("AVIATION_FEATURES.Catapult", ["无"], 1.5),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 1.5),
        ],
        "conflict": [
            ("WEAPON_SENSOR_FEATURES.VLS_Count_Level", ["122单元级", "122单元"], 12.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Position", ["舰艏和舰艉", "舰首和舰尾"], 10.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板", "斜角飞行甲板"], 10.0),
            ("AVIATION_FEATURES.Catapult", ["有"], 8.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 9.0),
            ("VISUAL_STRUCTURE.Hull_Form", ["三体船", "宽体三体船"], 10.0),
            ("TEXT_STRONG_CUES.Keywords", ["巡洋舰", "导弹巡洋舰", "122单元", "三体船", "濒海战斗舰", "两栖攻击舰", "船坞登陆舰"], 8.0),
        ],
    },
    ...
    "独立级濒海战斗舰": {
        "anchor": [
            ("VISUAL_STRUCTURE.Hull_Form", ["三体船", "宽体三体船"], 10.0),
            ("TEXT_STRONG_CUES.Keywords", ["三体船", "三体结构", "濒海战斗舰", "任务模块", "模块化任务", "铝合金船体", "45-50节"], 7.0),
            ("EQUIPMENT_DETAILS.Mission_Module", ["任务模块", "模块化任务"], 8.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Caliber", ["57mm级"], 6.0),
            ("TEXT_ATTRIBUTES.Speed", ["45", "50"], 5.0),
        ],
        "support": [
            ("VISUAL_STRUCTURE.Superstructure_Type", ["低矮隐身化上层建筑"], 4.0),
            ("VISUAL_STRUCTURE.Stealth_Shape", ["低矮隐身化外形"], 3.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["大型艉部直升机飞行甲板", "艉部直升机甲板"], 3.0),
            ("AVIATION_FEATURES.Aircraft_Capacity_Level", ["2架直升机或直升机+无人机级", "1-2架直升机级"], 2.5),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["无"], 2.0),
            ("TEXT_STRONG_CUES.Keywords", ["不是普通单体船", "左右支撑结构", "速度很快"], 4.0),
        ],
        "conflict": [
            ("VISUAL_STRUCTURE.Hull_Form", ["单体船", "大型单体船"], 8.0),
            ("WEAPON_SENSOR_FEATURES.Main_Gun_Caliber", ["76mm级", "127mm级"], 6.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 8.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板", "斜角飞行甲板"], 9.0),
            ("TEXT_STRONG_CUES.Keywords", ["普通单体船", "反潜护卫舰", "导弹巡洋舰", "导弹驱逐舰", "两栖攻击舰", "船坞登陆舰"], 7.0),
        ],
    },

    "黄蜂级两栖攻击舰": {
        "anchor": [
            ("TEXT_STRONG_CUES.Keywords", ["两栖攻击舰", "小航母", "垂直起降战斗机", "AV-8B", "F-35B", "STOVL", "3艘LCAC", "三艘LCAC", "41150吨"], 7.0),
            ("AVIATION_FEATURES.STOVL_Aircraft_Operation", ["有"], 7.0),
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板", "全通式飞行甲板"], 5.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 4.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["3艘LCAC", "三艘LCAC"], 7.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["41150", "四万"], 5.0),
            ("_RAW.raw_text", ["两栖攻击舰", "小航母", "垂直起降", "AV-8B", "F-35B", "3艘LCAC", "海军陆战队远征部队", "航空突击"], 7.0),
        ],
        "support": [
            ("AVIATION_FEATURES.Catapult", ["无"], 2.5),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 2.5),
            ("AVIATION_FEATURES.Aircraft_Capacity_Level", ["30架级", "大量固定翼舰载机"], 2.0),
            ("AMPHIBIOUS_FEATURES.Stern_Gate", ["有"], 3.0),
            ("AMPHIBIOUS_FEATURES.Troop_Transport", ["有", "强"], 3.0),
            ("AMPHIBIOUS_FEATURES.Amphibious_Assault_Capability", ["强", "中强"], 4.0),
            ("MISSION_FEATURES.Amphibious_Assault", ["强", "有"], 3.0),
        ],
        "conflict": [
            ("AVIATION_FEATURES.Catapult", ["有"], 10.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["有"], 10.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["10万吨", "100000"], 12.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["2艘LCAC", "4艘LCAC"], 8.0),
            ("TEXT_STRONG_CUES.Keywords", ["两栖船坞运输舰", "船坞登陆舰", "LPD", "LSD", "MV-22", "鱼鹰", "4艘LCAC", "2艘LCAC"], 8.0),
        ],
    },

    "圣安东尼奥级两栖船坞运输舰": {
        "anchor": [
            ("TEXT_STRONG_CUES.Keywords", ["两栖船坞运输舰", "船坞运输舰", "LPD", "MV-22", "鱼鹰", "封闭式桅杆", "一体化桅杆", "2艘LCAC", "25300吨", "720名"], 7.0),
            ("VISUAL_STRUCTURE.Mast_Feature", ["封闭式综合桅杆", "封闭式桅杆", "一体化桅杆"], 6.0),
            ("AVIATION_FEATURES.Hangar", ["直升机机库", "有直升机机库", "有"], 4.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 3.5),
            ("AMPHIBIOUS_FEATURES.Stern_Gate", ["有"], 3.0),
            ("AMPHIBIOUS_FEATURES.Vehicle_Deck", ["有", "车辆甲板"], 5.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["2艘LCAC", "两艘LCAC"], 7.0),
            ("TEXT_ATTRIBUTES.Troop_Capacity", ["720"], 5.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["25300"], 5.0),
            ("EQUIPMENT_DETAILS.Aircraft", ["MV-22", "鱼鹰"], 7.0),
            ("_RAW.raw_text", ["两栖船坞运输舰", "船坞运输舰", "LPD", "LPD类型", "MV-22", "鱼鹰", "鱼鹰支援", "2艘LCAC", "25300吨", "720名"], 7.0),
        ],
        "support": [
            ("AVIATION_FEATURES.Flight_Deck_Type", ["艉部直升机甲板"], 2.0),
            ("AVIATION_FEATURES.Catapult", ["无"], 2.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 2.0),
            ("AMPHIBIOUS_FEATURES.Troop_Transport", ["有", "强"], 3.0),
            ("MISSION_FEATURES.Primary_Mission", ["两栖运输能力", "运兵和装备"], 4.0),
            ("VISUAL_STRUCTURE.Superstructure_Type", ["大型封闭式上层建筑", "大型箱形隐身化上层建筑"], 4.0),
        ],
        "conflict": [
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板"], 8.0),
            ("AVIATION_FEATURES.STOVL_Aircraft_Operation", ["有"], 8.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["3艘LCAC", "4艘LCAC"], 8.0),
            ("AVIATION_FEATURES.Hangar", ["无", "无或有限"], 6.0),
            ("TEXT_STRONG_CUES.Keywords", ["两栖攻击舰", "船坞登陆舰", "LHD", "LSD", "4艘LCAC", "无机库"], 8.0),
        ],
    },

    "惠德比岛级船坞登陆舰": {
        "anchor": [
            ("TEXT_STRONG_CUES.Keywords", ["船坞登陆舰", "船坞登陆", "LSD", "井围甲板", "大型井围甲板", "4艘LCAC", "四艘LCAC", "无直升机库", "没有直升机库", "16100吨"], 7.0),
            ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱", "全通式泛水坞舱"], 4.0),
            ("AMPHIBIOUS_FEATURES.Stern_Gate", ["有"], 4.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capability", ["有", "强", "LCAC", "登陆艇"], 4.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["4艘LCAC", "四艘LCAC"], 8.0),
            ("AVIATION_FEATURES.Hangar", ["无", "无或有限"], 4.0),
            ("TEXT_ATTRIBUTES.Full_Load_Displacement", ["16100", "16000"], 5.0),
            ("TEXT_ATTRIBUTES.Troop_Capacity", ["627"], 4.0),
            ("_RAW.raw_text", ["船坞登陆舰", "LSD", "井围甲板", "4艘LCAC", "没有直升机库", "无机库"], 7.0),
        ],
        "support": [
            ("AVIATION_FEATURES.Flight_Deck_Type", ["艉部直升机甲板"], 2.0),
            ("AVIATION_FEATURES.Catapult", ["无"], 2.0),
            ("AVIATION_FEATURES.Arresting_Gear", ["无"], 2.0),
            ("MISSION_FEATURES.Landing_Operation", ["强", "有"], 3.0),
            ("MISSION_FEATURES.Primary_Mission", ["船坞登陆", "登陆运输", "两栖攻击"], 3.0),
            ("VISUAL_STRUCTURE.Stern_Form", ["船坞艉门", "大型船坞艉门"], 4.0),
        ],
        "conflict": [
            ("AVIATION_FEATURES.Flight_Deck_Type", ["全通飞行甲板"], 8.0),
            ("AVIATION_FEATURES.STOVL_Aircraft_Operation", ["有"], 8.0),
            ("AVIATION_FEATURES.Hangar", ["直升机机库", "有直升机机库", "有"], 6.0),
            ("AMPHIBIOUS_FEATURES.Landing_Craft_Capacity", ["2艘LCAC", "3艘LCAC"], 8.0),
            ("TEXT_STRONG_CUES.Keywords", ["两栖船坞运输舰", "两栖攻击舰", "LPD", "LHD", "MV-22", "鱼鹰", "2艘LCAC", "3艘LCAC"], 8.0),
        ],
    },
}

# v29b 校准：避免把共享的 SPY-1D/区域防空当作唯一已知类锚点。
# 这些仍然是 known-only 规则，只是在已知类内部区分“唯一锚点”和“共享支持特征”。
V29_CATEGORY_SLOT_CUES: Dict[str, List[Tuple[str, List[str], float]]] = {
    "航空母舰": [
        ("TEXT_STRONG_CUES.Keywords", ["航空母舰", "航母", "海上机场", "超级航母", "核动力航母"], 8.0),
        ("AVIATION_FEATURES.Catapult", ["有"], 6.0),
        ("AVIATION_FEATURES.Arresting_Gear", ["有"], 6.0),
    ],
    "巡洋舰": [
        ("TEXT_STRONG_CUES.Keywords", ["巡洋舰", "导弹巡洋舰", "宙斯盾巡洋舰", "舰队指挥", "指挥舰"], 8.0),
        ("WEAPON_SENSOR_FEATURES.VLS_Count_Level", ["122单元级", "122单元"], 8.0),
        ("WEAPON_SENSOR_FEATURES.Main_Gun_Position", ["舰艏和舰艉", "舰首和舰尾"], 7.0),
    ],
    "驱逐舰": [
        ("TEXT_STRONG_CUES.Keywords", ["驱逐舰", "导弹驱逐舰", "防空驱逐舰", "主力驱逐舰", "宙斯盾驱逐舰"], 8.0),
    ],
    "护卫舰": [
        ("TEXT_STRONG_CUES.Keywords", ["护卫舰", "巡防舰", "反潜护卫舰", "通用护卫舰", "中型护卫舰", "现代护卫舰", "反潜作战", "反潜作战取向", "反潜"], 8.0),
        ("WEAPON_SENSOR_FEATURES.Main_Gun_Caliber", ["76mm级", "57mm级"], 4.0),
    ],
    "两栖舰": [
        ("TEXT_STRONG_CUES.Keywords", ["两栖舰", "两栖攻击舰", "两栖船坞运输舰", "两栖运输舰", "LPD", "LHD"], 8.0),
        ("AMPHIBIOUS_FEATURES.Well_Deck", ["有", "大型坞舱"], 4.0),
    ],
    "登陆舰": [
        ("TEXT_STRONG_CUES.Keywords", ["登陆舰", "船坞登陆舰", "船坞登陆", "LSD", "登陆运输"], 8.0),
        ("VISUAL_STRUCTURE.Stern_Form", ["船坞艉门", "大型船坞艉门"], 5.0),
    ],
}

# 提康德罗加级：区域防空、AN/SPY-1 只是大型宙斯盾舰共享特征，移到 support。
_tico = V29_KNOWN_CLASS_SLOT_RULES.get("提康德罗加级导弹巡洋舰", {})
if _tico:
    _tico["anchor"] = [
        r for r in _tico.get("anchor", [])
        if r[0] not in {"MISSION_FEATURES.Primary_Mission", "EQUIPMENT_DETAILS.Radar_System", "EQUIPMENT_DETAILS.Combat_System"}
    ]
    _tico.setdefault("support", []).extend([
        ("MISSION_FEATURES.Primary_Mission", ["区域防空", "舰队指挥"], 3.0),
        ("EQUIPMENT_DETAILS.Combat_System", ["宙斯盾"], 2.5),
        ("EQUIPMENT_DETAILS.Radar_System", ["AN/SPY-1", "SPY-1"], 2.5),
    ])

# 阿利·伯克级：SPY-1D 是强支持，但不是唯一锚点；需要 Flight IIA/96单元/直升机库/尺寸等共同确认。
_burke = V29_KNOWN_CLASS_SLOT_RULES.get("阿利·伯克级驱逐舰", {})
if _burke:
    _burke["anchor"] = [
        r for r in _burke.get("anchor", [])
        if r[0] not in {"WEAPON_SENSOR_FEATURES.Radar_Array_Type", "EQUIPMENT_DETAILS.Radar_System"}
        and not (r[0] == "TEXT_STRONG_CUES.Keywords" and any("SPY-1D" in str(x) for x in r[1]))
    ]
    _burke.setdefault("support", []).extend([
        ("TEXT_STRONG_CUES.Keywords", ["SPY-1D", "AN/SPY-1D", "宙斯盾驱逐舰", "美国海军主力驱逐舰"], 3.0),
        ("WEAPON_SENSOR_FEATURES.Radar_Array_Type", ["AN/SPY-1D", "四面固定相控阵"], 2.5),
        ("EQUIPMENT_DETAILS.Radar_System", ["AN/SPY-1D"], 2.5),
    ])

# 对共享特征非常多的已知舰级，要求命中真正锚点才闭集输出。
# 例如“宙斯盾/Mk41/127mm/相控阵”是大型防空舰共享特征，不能单独证明为阿利·伯克级。
V29_REQUIRE_ANCHOR_CLASSES: List[str] = [
    "阿利·伯克级驱逐舰",
]

# 通用大类提示补充：仍是类别级常识，不指向任何未知舰级。
V29_CATEGORY_SLOT_CUES.setdefault("护卫舰", []).extend([
    ("MISSION_FEATURES.Anti_Submarine", ["有", "强"], 4.0),
    ("MISSION_FEATURES.Primary_Mission", ["反潜", "反潜为主", "巡防护航"], 5.0),
    ("WEAPON_SENSOR_FEATURES.Sonar_Feature", ["拖曳阵列声呐", "舰首声呐", "声呐"], 4.0),
    ("TEXT_STRONG_CUES.Keywords", ["反潜导弹", "拖曳声呐", "中型军舰", "中型水面舰"], 4.0),
])

# ============================================================
# v32 说明
# ============================================================
# v32 的主要修正逻辑在 run_deepseek.py 中完成：
# 1. 大类锁定优先；
# 2. 两栖攻击舰 / 两栖船坞运输舰 / 船坞登陆舰进一步区分；
# 3. 仍然不包含任何未知舰级名称或未知类专属签名。
# 这里保留 v29/v31 的已知类 slot 规则，供 run_deepseek v32 继续调用。
