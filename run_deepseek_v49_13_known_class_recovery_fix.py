...
# ==================== v49.13: conservative known-class recovery after v49.12 ====================
...
def v49_13_restore_arleigh_reason(text: str, result: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    # 高候选分 + 明确排除航母/两栖/登陆，只在驱逐舰大类或被误吸到两栖舰时恢复。
    final_cat = v49_11_final_category(result)
    if cand_conf >= 0.86 and has_gun and negative_amphib_carrier and final_cat in {"驱逐舰", "两栖舰"}:
        return True, "v49.13：阿利·伯克候选置信度很高，且有舰炮并排除航母/两栖/登陆方向，恢复为阿利·伯克级。"
...
def v49_13_restore_independence_reason(text: str, result: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    if has_trimaran and (has_57 or has_lcs or has_aviation_small):
        return True, "v49.13：三体结构 + 57mm/模块化/直升机平台等组合证据充分，恢复为独立级濒海战斗舰。"

    # 参数型独立级：75人、4300海里、57mm、RAM、MH-60 组合。
    if has_57 and has_aviation_small and v49_11_has_any(text, ["75人", "约75人", "4300海里", "4300"]):
        return True, "v49.13：75人/4300海里 + 57mm + RAM/MH-60 参数组合符合独立级，恢复为独立级濒海战斗舰。"

    if cand_conf >= 0.74 and has_trimaran:
        return True, "v49.13：独立级候选置信度较高且具备三体船核心锚点，恢复为独立级濒海战斗舰。"
...
def hierarchical_class_match(
    ...
    """v49.13：在 v49.12 基础上，窄范围修复阿利·伯克/独立级过度拒识。"""
